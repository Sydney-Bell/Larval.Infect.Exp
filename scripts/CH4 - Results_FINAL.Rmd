...
print(summary_contrasts_df %>% select(contrast, symbiont, host, temperature, mean_control))

# Combine with EMMs for plotting
emm_df <- as.data.frame(emm_simple) %>%
  left_join(summary_contrasts_df %>% 
              select(symbiont, host, temperature, mean_control, lower_control, 
